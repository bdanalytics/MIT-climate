...
title: "Global Climate: ESRL / NOAA:: Temp regression:: template2"
author: "bdanalytics"
...
model_id <- "Csm.1"; indep_vars_vctr <- c(NULL
...
Ntv.1.lm <- lm(reformulate(indep_vars_vctr, "Temp"), glb_trnobs_df)
print(summary(Ntv.1.lm))

model_id <- "Csm.1.step"; indep_vars_vctr <- c(NULL
...
Ntv.1.step.lm <- step(Ntv.1.lm)

model_id <- "Csm.2"; 
indep_vars_vctr <- c("MEI", "N2O", "TSI", "Aerosols")
for (method in c("lm")) {
    ret_lst <- myfit_mdl(model_id=model_id, model_method=method,
                                indep_vars_vctr=indep_vars_vctr,
                                model_type=glb_model_type,
